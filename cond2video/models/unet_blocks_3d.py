...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, image_hidden_states=None, 
                attention_mask=None, traj=None, traj_mask=None):
        hidden_states = self.resnets[0](hidden_states, temb)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            hidden_states = attn(hidden_states, encoder_hidden_states=encoder_hidden_states,
                                 image_hidden_states=image_hidden_states, traj=traj, traj_mask=traj_mask).sample
...
class CrossAttnDownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, image_hidden_states=None, attention_mask=None, traj=None,
                traj_mask=None):
        output_states = ()
